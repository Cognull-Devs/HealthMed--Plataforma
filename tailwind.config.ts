    ...
    extend: {
      ...
      colors: {
        ...
        health: {
          ...
          "surface-light": "hsl(var(--health-surface-light))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      backgroundImage: {
        ...
        "hero-pattern": "linear-gradient(135deg, hsl(222 47% 11%) 0%, hsl(217 91% 20%) 100%)",
        "card-gradient": "linear-gradient(145deg, hsl(222 47% 14%) 0%, hsl(222 47% 10%) 100%)",
      },
    },
  },
